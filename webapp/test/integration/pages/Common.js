sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("de/tammenit/svg/ui5con/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#UI5ConAttendees-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#UI5ConAttendees-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("de.tammenit.svg.ui5con.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["de/tammenit/svg/ui5con/localService/mockserver"], function (mockserver) {
